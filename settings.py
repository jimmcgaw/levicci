...
SECRET_KEY = '04ig=z@4b9ow1zn$+n144i@hc3#dyr-bh=770hsyrpwn81!foa'
...
MIDDLEWARE_CLASSES = (
    ...
    "trueplatform.shop.SSLMiddleware.SSLRedirect",
    "trueplatform.recentlist.middleware.RecentProductMiddleware",
)
...
TEMPLATE_CONTEXT_PROCESSORS = (
    ...
    'trueplatform.recentlist.context_processors.recent_products',
    'trueplatform.shop.context_processors.settings',
...
INSTALLED_APPS = (
    ...
    #'registration',
    'satchmo',
    'trueplatform.caching',
    'trueplatform.configuration',
    'trueplatform.shop',
    'trueplatform.contact',
    'trueplatform.product',
    # ****
    ...
    # ****
    #'trueplatform.product.brand',
    'trueplatform.shipping',
    'trueplatform.payment',
    'trueplatform.discount',
    'trueplatform.giftcertificate',
    'trueplatform.supplier',
    'trueplatform.thumbnail',
    'trueplatform.l10n',
    'trueplatform.tax',
    'trueplatform.recentlist',
    'trueplatform.wishlist',
    'trueplatform.upsell',
    'trueplatform.productratings',
    # ****
    ...
    # ****
    #'trueplatform.shipping.modules.tiered',
    # ****
    # * Optional feature newsletter
    # ****
    #'trueplatform.newsletter',
    # ****
    ...
    # ****
    #'trueplatform.product.tieredpricing',
    # ****
...
AUTHENTICATION_BACKENDS = (
    'trueplatform.accounts.email-auth.EmailBackend',
...
SATCHMO_SETTINGS = {
    ...
    #'SHOP_URLS' : patterns('trueplatform.shop.views',
    ...
    #   if you have trueplatform.feeds, make sure to include its URL
    #    (r'^feed/', include('trueplatform.feeds.urls')),
    #   likewise with newsletters
    #    (r'^newsletter/', include('trueplatform.newsletter.urls'))
    #   enable brands here
    #    (r'^brand/', include('trueplatform.product.brand.urls'))
    #}
