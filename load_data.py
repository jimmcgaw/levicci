...
from trueplatform.configuration import config_get_group
...
def delete_satchmo():
    """
    Delete all of the apps associated with trueplatform.
    """
...
def load_data():
    from trueplatform.contact.models import Contact, AddressBook, PhoneNumber
    from trueplatform.product.models import Product, Price, ConfigurableProduct, ProductVariation, Category, OptionGroup, Option, ProductImage#, DownloadableProduct
    from trueplatform.supplier.models import Organization
    from trueplatform.shop.models import Config
    from django.conf import settings
    from trueplatform.l10n.models import Country
...
def load_US_tax_table():
    ...
    from trueplatform.tax.models import TaxRate, TaxClass
    from trueplatform.l10n.models import AdminArea, Country
